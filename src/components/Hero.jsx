      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
          <h2 className="mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
            ...
            <span className="relative inline-block px-2">
              ...
              <span className="relative text-teal-900">
                (STEM | MBBS in Bangladesh | Literature | Applied Science | Life
                Science etc)
              </span>
            </span>
          </h2>
          <p className="mb-6 text-base text-indigo-100 md:text-lg">
            ...
            creative thinkers. Thats why more than 50,000 students from over 180
            different countries choose to study in Bangladesh every year. You
            could join them.
          </p>
