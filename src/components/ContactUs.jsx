export default function ContactUs() {
  return (
    <>
      <section className="bg-base-100 dark:bg-slate-800" id="contact">
            ...
            <div className="grid md:grid-cols-2">
              <div className="h-full pr-6">
                ...
                <ul className="mb-6 md:mb-0">
                  <li className="flex">
                    <div className="flex h-10 w-10 items-center justify-center rounded bg-deep-purple-accent-400 text-gray-50">
                      <svg
              ...
              <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                ...
                <form id="contactForm">
                  ...
                  <div className="text-center">
                    <button
                      type="submit"
                      className="w-full bg-deep-purple-accent-400 text-white px-6 py-3 font-xl rounded-md sm:mb-0"
                    >
                      Send Message
                    </button>
                  </div>
