          ...
          <tbody className="w-full text-left">
            ...
            <tr className="border-gray-200 border-b">
              <th>
                <img
                  className="my-10 pl-4 lg:pl-10 2xl:pl-20"
                  src="https://i.ibb.co/D40htNc/daniel-storek-JM-q-KEd1-GMI-unsplash-1.png"
                  alt="shoes"
                />
              </th>
              <th className="my-10 text-base font-medium leading-4 text-gray-600 pl-6 lg:pl-20 2xl:pl-52">
            ...
            <tr className="border-gray-200 border-b">
              <th>
                <img
                  className="my-10 pl-4 lg:pl-10 2xl:pl-20"
                  src="https://i.ibb.co/WsPGLM9/charles-deluvio-1-nx1-QR5d-TE-unsplash-1.png"
                  alt="glasses"
                />
              </th>
              <th className="my-10 text-base font-medium leading-4 text-gray-600 pl-6 lg:pl-20 2xl:pl-52">
            ...
            <tr className="border-gray-200 border-b">
              <th>
                <img
                  className="my-10 pl-4 lg:pl-10 2xl:pl-20"
                  src="https://i.ibb.co/k9YJ0q2/rocknwool-8-Lsy75-Lq-GVc-unsplash-1.png"
                  alt="girl"
                />
              </th>
              <th className="my-10 text-base font-medium leading-4 text-gray-600 pl-6 lg:pl-20 2xl:pl-52">
